...
export default class CriminalRecordCertificateMockService implements CriminalRecordCertificateServiceProvider {
    ...
    async sendApplication(): Promise<CriminalRecordCertOrderResponse> {
        return {
            id: randomInt(999999999),
            status: CriminalRecordCertOrderStatus.Completed,
        }
    }

    async checkStatus(): Promise<CriminalRecordCertificateStatus> {
        return CriminalRecordCertificateStatus.done
    }

    async downloadCertificate(): Promise<CriminalRecordCertDownloadResponse> {
        return { document: pdfFileBase64, signature: pdfFileBase64 }
    }

    async getOrderResult(): Promise<CriminalRecordCertOrderResult> {
        return {
